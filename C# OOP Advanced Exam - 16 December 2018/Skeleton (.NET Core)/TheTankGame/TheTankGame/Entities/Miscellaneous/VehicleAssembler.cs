namespace TheTankGame.Entities.Miscellaneous
{
    ...
    public class VehicleAssembler : IAssembler
    {
        ...
        public IReadOnlyCollection<IAttackModifyingPart> ArsenalParts => this.arsenalParts.ToList().AsReadOnly();

        public IReadOnlyCollection<IDefenseModifyingPart> ShellParts => this.shellParts.ToList().AsReadOnly();

        public IReadOnlyCollection<IHitPointsModifyingPart> EnduranceParts => this.enduranceParts.ToList().AsReadOnly();
        ...
        {
            this.arsenalParts.Add(arsenalPart as IAttackModifyingPart);
        }

        public void AddShellPart(IPart shellPart)
        {
            this.shellParts.Add(shellPart as IDefenseModifyingPart);
        }

        public void AddEndurancePart(IPart endurancePart)
        {
            this.enduranceParts.Add(endurancePart as IHitPointsModifyingPart);
        }
    }
}