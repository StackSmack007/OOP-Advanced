namespace CustomListIterator.Models
{
    using Contracts;
    using System;
    ...
    using System.Text;
    using System.Linq;
    public class CustomerList<T> : IEnumerable, ICustomerList<T>
        where T : IComparable
    {
        private T[] array;
        private int count;
       ...
       public T this[int number]
       {
           get
           {
               ...
               throw new IndexOutOfRangeException("Not existing elementIndex");
           }
           set
           {
               if (number >= 0 && number < Count)
